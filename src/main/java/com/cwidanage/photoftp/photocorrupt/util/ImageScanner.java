...
public final class ImageScanner {
	 ...
	 */
	public static Result scan(File file, ImageFormat imgFormat) throws IOException {

		Result result = new Result();
		ImageReader imgReader = ImageIO.getImageReadersByFormatName(imgFormat.toString()).next();

		try (InputStream imgInputStream = new FileInputStream(file)) {
